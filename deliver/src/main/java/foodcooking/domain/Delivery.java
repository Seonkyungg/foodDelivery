...
import foodcooking.domain.Picked;
import foodcooking.domain.Delivered;
...
public class Delivery  {
    ...
    public static DeliveryRepository repository(){
        DeliveryRepository deliveryRepository = DeliverApplication.applicationContext.getBean(DeliveryRepository.class);
